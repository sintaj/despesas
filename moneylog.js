...
// Custom CSS
addStyleSheet('mystyle','#app-name {font-size: 20px;} #logo {background-color: #FEF03A;}');
addStyleSheet('mystyle', '#source-file-box.mini {display: none;}');
addStyleSheet('mystyle', '.button.active, a.button:active {border-color: #EA353D; background-color: #FEF03A;}');
addStyleSheet('mystyle','a.button.active {color: #EA353D;} #logo a {color: #EA353D;}.widget-content a {color: #E94D2B;}');
...
var dataFiles = ['despesas.txt'];               // The paths for the TXT data files
var dataFilesDefault = 'despesas.txt';        // Default selected file at init when using multiple TXT
...
var i18nDatabase = {
	...
	pt: {
		...
		// App
		appUrl: 'http://sintaj.org/',
		appUrlOnline: 'http://sintaj.org/',
		appDescription: 'Acompanhe suas finanças de maneira simples e prática. Descomplique!',
		helpWebsite: 'Visite o website do Sintaj.'
...
// Global vars
var appVersion = '1β';
var appYear = '2016';  // only used in official releases
var appName = 'Despesas Sintaj';
var appFlavor = '';
...
AboutWidget.populate = function () {
	...
	html.push(linkme('http://calheira.com', 'Bruno Calheira'));
	html.push(linkme('http://aurelio.net/moneylog/', 'Baseado no Moneylog'));
	html.push('</div>');
